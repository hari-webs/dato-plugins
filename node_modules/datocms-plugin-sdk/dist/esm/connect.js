...
import { renderItemFormSidebarPanelBootstrapper, } from './hooks/renderItemFormSidebarPanel';
import { renderManualFieldExtensionConfigScreenBootstrapper, } from './hooks/renderManualFieldExtensionConfigScreen';
import { renderModalBootstrapper } from './hooks/renderModal';
import { renderPageBootstrapper } from './hooks/renderPage';
                ...
                case 2:
                    ...
                    if (initialProperties.mode === 'onBoot') {
                        ...
                        callMethodMergingBootCtxExecutor = function (methodName, methodArgs, extraCtxProperties, extraCtxMethodKeys, methodCallId) {
                            ...
                            return (_a = configuration)[methodName].apply(_a, __spreadArray(__spreadArray([], methodArgs, false), [__assign(__assign(__assign(__assign({}, omit(methods, ['getSettings', 'setHeight'])), omit(currentProperties_1, ['mode', 'bodyPadding'])), Object.fromEntries(extraCtxMethodKeys.map(function (methodName) { return [
                                    methodName,
